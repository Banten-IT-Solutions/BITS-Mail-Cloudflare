...
const messages: LocaleMessages = {
  ...
  NewAddressAnonymousDisabledMsg:
    'New address for anonymous user is disabled, please contact the administrator',
  ...
  UserDeleteEmailDisabledMsg:
    'User delete address/email is disabled, please contact the administrator',
  ...
  VerifyMailSenderNotSetMsg:
    'Verify mail sender address is not set, please contact the administrator',
  ...
  FailedUpdateUserDefaultRoleMsg:
    'Failed to update user default role, please contact the administrator',
  ...
  TgLangFeatureDisabledMsg:
    'Language setting feature is disabled. System default language is used.',
};
