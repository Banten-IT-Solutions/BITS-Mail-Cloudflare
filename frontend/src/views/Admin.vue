...
const { t, locale } = useI18n({
  messages: {
    ...
    id: {
      accessHeader: 'Kata Sandi Admin',
      accessTip: 'Silakan masukkan kata sandi admin',
      mails: 'Email',
      sendMail: 'Kirim Surat',
      qucickSetup: 'Pengaturan Cepat',
      account: 'Akun',
      ...
      userOauth2Settings: 'Pengaturan OAuth2',
      roleAddressConfig: 'Konfigurasi Alamat Peran',
      unknow: 'Email dengan penerima tidak diketahui',
      senderAccess: 'Kontrol Akses Pengirim',
      ...
      database: 'Basis Data',
      workerconfig: 'Konfigurasi Worker',
      ipBlacklistSettings: 'Daftar Hitam IP',
      aiExtractSettings: 'Pengaturan Ekstraksi AI',
      appearance: 'Tampilan',
      about: 'Tentang',
      ok: 'OK',
      mailWebhook: 'Webhook Email',
      adminAccount: 'Admin',
      loginMethod: 'Metode Login',
      loginViaPassword: 'Login dengan Kata Sandi Admin',
      loginViaUserAdmin: 'Izin Admin Pengguna',
      loginViaDisabledCheck: 'Pemeriksaan Kata Sandi Dinonaktifkan',
      logout: 'Keluar',
      logoutConfirmTitle: 'Konfirmasi Keluar',
      logoutConfirmContent: 'Apakah Anda yakin ingin keluar dari panel admin?',
      confirm: 'Konfirmasi',
