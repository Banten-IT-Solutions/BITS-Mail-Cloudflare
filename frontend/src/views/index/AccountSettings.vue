...
const { jwt, settings, showAddressCredential, loading, openSettings } = useGlobalState();
...
const { locale, t } = useI18n({
  messages: {
    ...
    id: {
      ...
      showAddressCredential: 'Tampilkan Kredensial Alamat',
      logoutConfirm: 'Apakah Anda yakin ingin keluar?',
      deleteAccountConfirm: 'Apakah Anda yakin menghapus akun ini dan semua emailnya?',
      clearInbox: 'Bersihkan Kotak Masuk',
      clearSentItems: 'Bersihkan Kotak Keluar',
      clearInboxConfirm: 'Apakah Anda yakin ingin membersihkan semua email di kotak masuk?',
      clearSentItemsConfirm: 'Apakah Anda yakin ingin membersihkan semua email di kotak keluar?',
      success: 'Berhasil',
