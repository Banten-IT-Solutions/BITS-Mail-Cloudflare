...
const { t } = useI18n({
  ...
  messages: {
    en: {
      successSend:
        'Please check your sendbox. If failed, please check your balance or try again later.',
      ...
      requestAccessTip:
        'No send balance yet. If your admin enabled a default balance it should be assigned automatically; otherwise request access or contact the admin.',
    ...
    id: {
      successSend:
        'Silakan cek kotak terkirim. Jika gagal, periksa saldo Anda atau coba lagi nanti.',
      ...
      requestAccessTip:
        'Belum ada saldo kirim. Jika admin mengaktifkan saldo default, saldo akan ditambahkan otomatis; jika tidak, minta akses atau hubungi admin.',
