...
const { jwt, settings, showAddressCredential, userJwt, isTelegram, addressPassword } =
  useGlobalState();
...
const { locale, t } = useI18n({
  messages: {
    ...
    id: {
      ok: 'OK',
      fetchAddressError:
        'Kredensial alamat email tidak valid atau akun tidak ada, mungkin ada masalah koneksi jaringan, silakan coba lagi nanti.',
      addressCredential: 'Kredensial Alamat Email',
      linkWithAddressCredential: 'Buka untuk tautan masuk otomatis email',
      addressCredentialTip:
        'Salin Kredensial Alamat Email dan gunakan untuk masuk ke akun email Anda.',
