...
const { locale, t } = useI18n({
    messages: {
        ...
        id: {
            ...
            pleaseGetNewEmail: 'Silakan masuk atau klik tombol "Dapatkan Email Baru" untuk mendapatkan alamat email baru',
            ...
            bindUserInfo: 'Pengguna yang masuk, login tanpa mengikat email atau membuat alamat email baru akan mengikat ke pengguna saat ini',
            ...
            randomSubdomainTip: 'Saat diaktifkan, alamat yang dibuat akan menggunakan subdomain acak. Alamat subdomain direkomendasikan untuk menerima saja.',
        },
    }
});
