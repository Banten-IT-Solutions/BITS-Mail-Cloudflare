...
const { locale, t } = useI18n({
  messages: {
    en: {
      ...
      unbindAddressTip:
        'Before unbinding, please switch to this email address and save the email address credential.',
      transferAddress: 'Transfer Address',
      targetUserEmail: 'Target User Email',
      transferAddressTip:
        'Transfer address to another user will remove the address from your account and transfer it to another user. Are you sure to transfer the address?',
      address: 'Address',
    ...
    id: {
      ...
      unbindAddressTip:
        'Sebelum melepas ikatan, silakan beralih ke alamat email ini dan simpan kredensial alamat email.',
      transferAddress: 'Transfer Alamat',
      targetUserEmail: 'Email Pengguna Tujuan',
      transferAddressTip:
        'Transfer alamat ke pengguna lain akan menghapus alamat dari akun Anda dan mentransfernya ke pengguna lain. Anda yakin ingin transfer alamat?',
      address: 'Alamat',
