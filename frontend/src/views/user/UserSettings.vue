...
const { t } = useI18n({
    messages: {
        ...
        id: {
            ...
            passordTip: 'Server hanya akan menerima nilai hash dari kata sandi, dan tidak akan menerima kata sandi dalam teks biasa, sehingga tidak dapat melihat atau mengambulkan kata sandi Anda. Jika administrator mengaktifkan verifikasi email, Anda dapat mengatur ulang kata sandi dalam mode inkognito',
            createPasskey: 'Buat Passkey',
            showPasskeyList: 'Tampilkan Daftar Passkey',
            passkeyCreated: 'Passkey berhasil dibuat',
            passkeyNamePlaceholder: 'Silakan masukkan nama passkey atau biarkan kosong untuk menghasilkan nama acak',
