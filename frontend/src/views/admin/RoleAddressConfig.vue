...
const { t } = useI18n({
  messages: {
    en: {
      ...
      roleConfigDesc:
        'Configure maximum address count for each user role. Role-based limits take priority over global settings. Set 0 for unlimited.',
    ...
    id: {
      ...
      roleConfigDesc:
        'Konfigurasi jumlah alamat maksimum untuk setiap peran pengguna. Batas berbasis peran mengambil prioritas di atas pengaturan global. Atur 0 untuk tak terbatas.',
