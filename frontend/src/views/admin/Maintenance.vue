...
const { t } = useI18n({
    messages: {
        ...
        id: {
            ...
            save: "Simpan",
            cronTip: "Aktifkan pembersihan cron, perlu mengonfigurasi [crons] di worker, lihat dokumen, pengaturan 0 hari berarti hapus semua",
            basicCleanup: "Pembersihan Dasar",
            customSqlCleanup: "Pembersihan SQL Khusus",
            customSqlTip: "Tambahkan pernyataan SQL DELETE khusus untuk pembersihan terjadwal. Hanya satu pernyataan DELETE yang diperbolehkan per entri.",
            addCustomSql: "Tambahkan SQL Khusus",
            sqlName: "Nama",
            sqlStatement: "Pernyataan SQL (hanya DELETE)",
            sqlNamePlaceholder: "mis. Bersihkan log lama",
            sqlPlaceholder: "mis. DELETE FROM raw_mails WHERE source GLOB '*{'@'}example.com' AND created_at < datetime('now', '-3 day')",
