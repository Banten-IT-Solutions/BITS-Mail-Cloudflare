...
const { t } = useI18n({
  messages: {
    ...
    id: {
      ...
      delete: 'Hapus',
      deleteUserTip: 'Apakah Anda yakin ingin menghapus pengguna ini?',
      resetPassword: 'Atur Ulang Kata Sandi',
      pleaseInput: 'Silakan masukkan informasi lengkap',
      ...
      prefix: 'Awalan',
      domains: 'Domain',
      roleDonotExist: 'Peran saat ini tidak tersedia',
      userAddressManagement: 'Manajemen Alamat',
    },
  },
});
const data = ref([]);
...
const getRoleDomains = role => {
  ...
  if (res === undefined || res === null || res.length == 0)
    return openSettings.value.defaultDomains;
  return res;
};
...
<template>
  <div style="margin-top: 10px">
    ...
    <n-modal
      v-model:show="showUserAddressManagement"
      preset="card"
      :title="t('userAddressManagement')"
    >
