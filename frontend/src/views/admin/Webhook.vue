...
const { t } = useI18n({
  messages: {
    en: {
      ...
      webhookAllowList:
        'Webhook Allow List(Enter the mail address that is allowed to use webhook and enter)',
    ...
    id: {
      ...
      webhookAllowList:
        'Daftar Putih Webhook (Masukkan alamat email yang diizinkan menggunakan webhook dan tekan Enter)',
  ...
  <div class="center">
    ...
    >
      ...
      <n-form-item-row :label="t('webhookAllowList')">
        <n-select
          v-model:value="webhookSettings.allowList"
          filterable
          multiple
          tag
