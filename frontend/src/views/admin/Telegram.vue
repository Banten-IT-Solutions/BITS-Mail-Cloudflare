  ...
  messages: {
    en: {
      ...
      globalMailPushListTip:
        'Support chat_id of private chat/group/channel. You can send a message to your bot, then visit this link to see chat_id, https://api.telegram.org/bot<Replace with your BOT TOKEN>/getUpdates',
    },
    id: {
      init: 'Inisialisasi',
      successTip: 'Berhasil',
      ...
      enableGlobalMailPush:
        'Aktifkan Dorongan Email Global (Masukkan Chat ID telegram secara manual)',
      globalMailPushList: 'Daftar Chat ID Dorongan Email Global',
      globalMailPushListTip:
        'Mendukung chat_id obrolan pribadi/grup/kanal. Anda dapat mengirim pesan ke bot Anda, lalu kunjungi tautan ini untuk melihat chat_id, https://api.telegram.org/bot<Ganti dengan TOKEN BOT Anda>/getUpdates',
    },
  },
});
      ...
      <n-card :bordered="false" embedded>
        ...
        <n-form-item-row :label="t('enableGlobalMailPush')">
          <n-input-group>
            ...
            <n-select
              v-model:value="settings.globalMailPushList"
              filterable
              multiple
              tag
              style="width: 80%"
