...
const { t } = useI18n({
  messages: {
    en: {
      ...
      enableMailVerify:
        'Enable Mail Verify (Send address must be an address in the system with a balance and can send mail normally)',
    ...
    id: {
      ...
      enableMailVerify:
        'Aktifkan Verifikasi Email (Alamat pengirim harus berupa alamat di sistem dengan saldo dan dapat mengirim email dengan normal)',
      ...
      emailCheckRegex:
        "Regex Pemeriksa Email (mis. ^[^.]+{'@'}.+$ untuk melarang titik sebelum {'@'})",
